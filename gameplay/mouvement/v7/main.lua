...
function love.load()
  ...
  bordure_gauche = 0
  bordure_droite = largeur
  
  sol = {}
  sol.x1 = bordure_gauche
  sol.x2 = bordure_droite
  sol.y = hauteur-50
...
function love.update(dt)
  ...
  if joueur.x >= bordure_droite-joueur.w then
    joueur.x = bordure_droite-joueur.w
    joueur.vitesse = 0
  end
  if joueur.x <= bordure_gauche then
    joueur.x = bordure_gauche
    joueur.vitesse = 0
  end
end
